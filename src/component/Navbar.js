  ...
  return (
    <header className="  text-gray-600 body-font shadow-lg  z-50 block sticky ">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <Link to="/cart"><button className="inline-flex items-center bg-indigo-500 border-0 py-2 px-4 text-white focus:outline-none hover:bg-gray-400 rounded text-base mt-4 md:mt-0">Cart - ({cartItem.length} Items)
        </button></Link>
