...
export default function Navbar() {
  ...
  return (
    <header className="  text-gray-600 body-font shadow-lg  z-50 block ">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center  justify-center text-black text-lg ">
          ...
          <a href="a" className="mr-5 hover:text-gray-900">Contact Us</a>
          <a href="a"  className="mr-5 hover:text-gray-900">Services</a>
